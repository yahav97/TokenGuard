...
**Initialization:**
    ...
    client = TokenGuardClient(api_key="your_admin_key", base_url="http://127.0.0.1:8000")
...
**Initialization:**
    ...
    const client = new TokenGuardWebClient("http://127.0.0.1:8000");
...
### Example 1: Python Automation Script
    ...
    tg = TokenGuardClient(api_key="admin_key", base_url="http://127.0.0.1:8000")
...
### Example 2: React Web App Integration
    ...
    export default function SmartTextEditor() {
      ...
      const tg = new TokenGuardWebClient("http://127.0.0.1:8000");
      ...
      return (
        <div>
          ...
          <p><i>Generated by: {modelUsed}</i></p>
          <div>{response}</div>
        </div>
      );
    }
...
### Example 3: React Native (Mobile) Integration
    ...
    export default function MobileAssistant() {
      ...
      const tg = new TokenGuardWebClient("http://10.0.2.2:8000");
...
### Example 4: Native Android Integration (Kotlin)
    ...
    val gatewayUrl = "http://10.0.2.2:8000/gateway/generate"
